$(document).ready(function(){
    ...
    var teams = "ars avi bur che cpa eve hul lei liv mnc mnu new qpr shm stk sun swa tot wbm whm";
    ...
    function imageSelect(str){
        switch (str) {
            case "Arsenal":
                ...
                $("#filterResults").removeClass( teams );
                $("#filterResults").addClass( "ars" );
                $("#navBar").addClass( "ars" );
                break;
            case "Aston Villa":
